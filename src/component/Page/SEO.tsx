...
export default function SEO({ children, description, image, largeImage, title, ...props }: SEOProps) {
  ...
  return <Helmet title={title} {...props}>
    ...
    {image && largeImage && <meta name="twitter:card" content="summary_large_image" />}
